...
class TestBuildMetrics:
    def test_aggregates_state_and_service_counters(self) -> None:
        ...
        assert metrics.verified_quotes == 2
        assert metrics.unverified_quotes == 1
    ...
    def test_citation_rates_are_derived_from_verification(self) -> None:
        ...
        assert metrics.citation_coverage_rate == 0.75  # 3 of 4 factual claims cited
        assert metrics.citation_support_rate == 0.75  # 3 of 4 checked claims supported
...
class TestEvaluators:
    def test_evaluates_a_completed_run(self) -> None:
        ...
        assert results["citation_validity"].value == 1.0
